        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center max-w-md mx-4">
            <form onSubmit={handleSearch} className="relative flex-1">
              ...
              <button 
                type="submit"
                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-lumina-gold hover:text-lumina-dark transition-colors"
              >
              ...
              <form onSubmit={handleSearch} className="px-3 py-2">
                <div className="flex">
                  <input
                    ...
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="w-full pl-4 pr-4 py-2 border border-lumina-silver rounded-l-full focus:outline-none focus:ring-2 focus:ring-lumina-gold font-roboto"
                  />
                  <button
                    type="submit"
                    className="bg-lumina-gold text-white px-4 rounded-r-full"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
